...
class TestStabilityTests:
    ...
    def test_deterministic_parsing_results(self):
        ...
        with patch.object(parser, '_convert_document') as mock_convert:
            ...
            results1 = parser.parse_document(Path("/Users/joecorella/Desktop/PDF Parsing/tests/test.pdf"))
            results2 = parser.parse_document(Path("/Users/joecorella/Desktop/PDF Parsing/tests/fixtures/large_pages_light.pdf"))
            results3 = parser.parse_document(Path("/Users/joecorella/Desktop/PDF Parsing/tests/fixtures/multicolumn_rotated.pdf"))
