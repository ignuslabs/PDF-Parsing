...
class TestKeyValueExtractor:
    ...
    def create_test_element(self, text: str, bbox: Dict[str, float], page_number: int = 1, 
                           element_type: str = 'text', confidence: float = 0.85) -> DocumentElement:
    ...
    def create_form_elements(self, page_width: float = 612.0, page_height: float = 792.0) -> List[DocumentElement]:
        ...
        # Form heading
        elements.append(self.create_test_element(
        ...
        elements.extend([
            # Name: John A. Smith
            self.create_test_element("Name:", {'x0': 50.0, 'y0': 650.0, 'x1': 90.0, 'y1': 670.0}),
            self.create_test_element("John A. Smith", {'x0': 100.0, 'y0': 650.0, 'x1': 200.0, 'y1': 670.0}),
            
            # Date of Birth: 01/23/1980
            self.create_test_element("Date of Birth:", {'x0': 50.0, 'y0': 620.0, 'x1': 130.0, 'y1': 640.0}),
            self.create_test_element("01/23/1980", {'x0': 140.0, 'y0': 620.0, 'x1': 210.0, 'y1': 640.0}),
        ])
        
        # Below pairs - left column
        elements.extend([
            # Address: (multi-line value below)
            self.create_test_element("Address:", {'x0': 50.0, 'y0': 580.0, 'x1': 110.0, 'y1': 600.0}),
            self.create_test_element("123 Main Street", {'x0': 50.0, 'y0': 560.0, 'x1': 150.0, 'y1': 580.0}),
            self.create_test_element("Apartment 4B", {'x0': 50.0, 'y0': 540.0, 'x1': 140.0, 'y1': 560.0}),
            self.create_test_element("Springfield, IL 62701", {'x0': 50.0, 'y0': 520.0, 'x1': 180.0, 'y1': 540.0}),
        ])
        
        # Same-line pairs - right column (after gutter)
        elements.extend([
            # SSN: 123-45-6789
            self.create_test_element("SSN:", {'x0': 350.0, 'y0': 650.0, 'x1': 380.0, 'y1': 670.0}),
            self.create_test_element("123-45-6789", {'x0': 390.0, 'y0': 650.0, 'x1': 480.0, 'y1': 670.0}),
            
            # Phone: (555) 123-4567
            self.create_test_element("Phone:", {'x0': 350.0, 'y0': 620.0, 'x1': 390.0, 'y1': 640.0}),
            self.create_test_element("(555) 123-4567", {'x0': 400.0, 'y0': 620.0, 'x1': 500.0, 'y1': 640.0}),
        ])
        
        # Below pairs - right column  
        elements.extend([
            # Emergency Contact:
            self.create_test_element("Emergency Contact:", {'x0': 350.0, 'y0': 580.0, 'x1': 470.0, 'y1': 600.0}),
            self.create_test_element("Mary Johnson", {'x0': 350.0, 'y0': 560.0, 'x1': 430.0, 'y1': 580.0}),
            self.create_test_element("(555) 987-6543", {'x0': 350.0, 'y0': 540.0, 'x1': 450.0, 'y1': 560.0}),
        ])
        ...
        elements.extend([
            ...
            self.create_test_element("Table Data", {'x0': 50.0, 'y0': 450.0, 'x1': 150.0, 'y1': 470.0}, element_type='table'),
            
            # Image element (should be excluded from values)
            self.create_test_element("Image Caption", {'x0': 300.0, 'y0': 450.0, 'x1': 400.0, 'y1': 470.0}, element_type='image')
        ])
    ...
    def test_detects_colon_ended_labels(self):
        ...
        elements = [
            ...
            self.create_test_element("John Smith", {'x0': 100.0, 'y0': 100.0, 'x1': 170.0, 'y1': 120.0}),
            
            self.create_test_element("Address:", {'x0': 50.0, 'y0': 80.0, 'x1': 110.0, 'y1': 100.0}),
            self.create_test_element("123 Main St", {'x0': 120.0, 'y0': 80.0, 'x1': 200.0, 'y1': 100.0}),
            
            self.create_test_element("Phone Number:", {'x0': 50.0, 'y0': 60.0, 'x1': 140.0, 'y1': 80.0}),
            self.create_test_element("555-1234", {'x0': 150.0, 'y0': 60.0, 'x1': 220.0, 'y1': 80.0})
        ]
    ...
    def test_detects_short_left_aligned_labels(self):
        ...
        elements = [
            ...
            self.create_test_element("John Smith", {'x0': 95.0, 'y0': 100.0, 'x1': 170.0, 'y1': 120.0}),
            
            self.create_test_element("Date", {'x0': 50.0, 'y0': 80.0, 'x1': 85.0, 'y1': 100.0}),
            self.create_test_element("01/15/2024", {'x0': 95.0, 'y0': 80.0, 'x1': 165.0, 'y1': 100.0}),
        ]
    ...
    def test_rejects_long_paragraphs_as_labels(self):
        ...
        elements = [
            ...
            self.create_test_element("Some value", {'x0': 50.0, 'y0': 80.0, 'x1': 120.0, 'y1': 100.0}),
            
            # Valid short label - should be detected  
            self.create_test_element("Name:", {'x0': 50.0, 'y0': 60.0, 'x1': 90.0, 'y1': 80.0}),
            self.create_test_element("John Smith", {'x0': 100.0, 'y0': 60.0, 'x1': 170.0, 'y1': 80.0})
        ]
    ...
    def test_prefers_same_line_pairing(self):
        ...
        elements = [
            ...
            self.create_test_element("Alternative Value", {'x0': 50.0, 'y0': 80.0, 'x1': 150.0, 'y1': 100.0})
        ]
    ...
    def test_fallback_to_below_pairing(self):
        ...
        elements = [
            ...
            self.create_test_element("Address:", {'x0': 50.0, 'y0': 100.0, 'x1': 110.0, 'y1': 120.0}),
            # Value below with good x-alignment
            self.create_test_element("123 Main Street", {'x0': 55.0, 'y0': 80.0, 'x1': 155.0, 'y1': 100.0})
        ]
    ...
    def test_respects_vertical_window_for_below_pairing(self):
        ...
        elements = [
            ...
            self.create_test_element("Far Value", {'x0': 50.0, 'y0': 40.0, 'x1': 120.0, 'y1': 60.0}),
            # Value within window (distance = 30 < 50)
            self.create_test_element("Near Value", {'x0': 50.0, 'y0': 70.0, 'x1': 130.0, 'y1': 90.0})
        ]
    ...
    def test_merges_multi_line_values(self):
        ...
        elements = [
            self.create_test_element("Address:", {'x0': 50.0, 'y0': 120.0, 'x1': 110.0, 'y1': 140.0}),
            # Multi-line address value
            self.create_test_element("123 Main Street", {'x0': 50.0, 'y0': 100.0, 'x1': 150.0, 'y1': 120.0}),
            self.create_test_element("Apartment 4B", {'x0': 50.0, 'y0': 80.0, 'x1': 140.0, 'y1': 100.0}),
            self.create_test_element("Springfield, IL 62701", {'x0': 50.0, 'y0': 60.0, 'x1': 180.0, 'y1': 80.0})
        ]
    ...
    def test_prevents_cross_gutter_pairing(self):
        ...
        elements = [
            ...
            # Right column value
            self.create_test_element("123-45-6789", {'x0': 390.0, 'y0': 100.0, 'x1': 480.0, 'y1': 120.0})
        ]
    ...
    def test_higher_confidence_for_strong_pairs(self):
        ...
        strong_elements = [
            self.create_test_element("Name:", {'x0': 50.0, 'y0': 100.0, 'x1': 90.0, 'y1': 120.0}),
            self.create_test_element("John Smith", {'x0': 95.0, 'y0': 100.0, 'x1': 165.0, 'y1': 120.0})
        ]
        
        # Weak pair: no colon, distant value
        weak_elements = [
            self.create_test_element("Label", {'x0': 50.0, 'y0': 100.0, 'x1': 85.0, 'y1': 120.0}),
            self.create_test_element("Value", {'x0': 200.0, 'y0': 70.0, 'x1': 240.0, 'y1': 90.0})  # Far away
        ]
    ...
    def test_prevents_duplicate_value_assignment(self):
        ...
        elements = [
            ...
            self.create_test_element("First Name:", {'x0': 50.0, 'y0': 100.0, 'x1': 120.0, 'y1': 120.0}),
            self.create_test_element("Name:", {'x0': 50.0, 'y0': 80.0, 'x1': 90.0, 'y1': 100.0}),
            # Single value that both could claim
            self.create_test_element("John Smith", {'x0': 130.0, 'y0': 95.0, 'x1': 200.0, 'y1': 115.0})
        ]
    ...
    def test_excludes_non_text_elements_from_values(self):
        ...
        elements = [
            ...
            self.create_test_element("Table Content", {'x0': 100.0, 'y0': 100.0, 'x1': 200.0, 'y1': 120.0}, element_type='table'),
            self.create_test_element("Image Caption", {'x0': 210.0, 'y0': 100.0, 'x1': 300.0, 'y1': 120.0}, element_type='image'),
            self.create_test_element("Heading Text", {'x0': 310.0, 'y0': 100.0, 'x1': 400.0, 'y1': 120.0}, element_type='heading'),
            # This should be a valid value
            self.create_test_element("John Smith", {'x0': 100.0, 'y0': 80.0, 'x1': 170.0, 'y1': 100.0}, element_type='text')
        ]
    ...
    def test_processes_multiple_pages_independently(self):
        ...
        elements = [
            # Page 1 elements
            self.create_test_element("Name:", {'x0': 50.0, 'y0': 100.0, 'x1': 90.0, 'y1': 120.0}, page_number=1),
            self.create_test_element("John Smith", {'x0': 100.0, 'y0': 100.0, 'x1': 170.0, 'y1': 120.0}, page_number=1),
            
            # Page 2 elements  
            self.create_test_element("Address:", {'x0': 50.0, 'y0': 100.0, 'x1': 110.0, 'y1': 120.0}, page_number=2),
            self.create_test_element("123 Main St", {'x0': 120.0, 'y0': 100.0, 'x1': 200.0, 'y1': 120.0}, page_number=2)
        ]
    ...
    def test_handles_empty_text_gracefully(self):
        ...
        elements = [
            self.create_test_element("", {'x0': 50.0, 'y0': 100.0, 'x1': 90.0, 'y1': 120.0}),  # Empty
            self.create_test_element("   ", {'x0': 100.0, 'y0': 100.0, 'x1': 140.0, 'y1': 120.0}),  # Whitespace
            self.create_test_element("Name:", {'x0': 50.0, 'y0': 80.0, 'x1': 90.0, 'y1': 100.0}),  # Valid
            self.create_test_element("John", {'x0': 100.0, 'y0': 80.0, 'x1': 140.0, 'y1': 100.0})  # Valid
        ]
    ...
    def test_handles_malformed_bboxes_gracefully(self):
        ...
        elements = [
            ...
            # Very wide element  
            self.create_test_element("This is a very wide value element", {'x0': 60.0, 'y0': 100.0, 'x1': 500.0, 'y1': 120.0}),
            # Very tall element
    ...
    def test_complex_multi_line_scenario(self):
        ...
        elements = [
            # Label
            self.create_test_element("Description:", {'x0': 50.0, 'y0': 150.0, 'x1': 130.0, 'y1': 170.0}),
            
            # Multi-line value with varying x-positions (testing alignment tolerance)
            self.create_test_element("This is a long description that", {'x0': 50.0, 'y0': 130.0, 'x1': 250.0, 'y1': 150.0}),
            self.create_test_element("spans multiple lines with different", {'x0': 52.0, 'y0': 110.0, 'x1': 260.0, 'y1': 130.0}),  # Slightly offset
            self.create_test_element("alignment and should be merged.", {'x0': 51.0, 'y0': 90.0, 'x1': 240.0, 'y1': 110.0})  # Slightly offset
        ]
...
def create_large_form_document(pages: int = 5, elements_per_page: int = 50) -> List[DocumentElement]:
