...
class ExportHandler:
    ...
    def create_download_link(
        self, data: str, filename: str, link_text: str = "Download", mime_type: str = "text/plain"
    ) -> str:
    ...
    def create_zip_download(self, files: Dict[str, str], zip_filename: str = None) -> bytes:
    ...
    def display_download_section(self, files: Dict[str, str], title: str = "Download Files"):
    ...
    def display_file_previews(
        self, files: Dict[str, str], title: str = "File Previews", max_preview_length: int = 1000
    ):
    ...
    def _display_single_preview(self, filename: str, content: str, max_length: int = 1000):
