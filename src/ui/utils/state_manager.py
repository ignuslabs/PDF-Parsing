...
class DocumentStateManager(StateManager):
    ...
    def _setup_document_state(self):
        ...
        self.register_state('search_filters', {
            'element_types': [],
            'page_range': None,
        ...
        self.register_state('parser_config', {
            'enable_ocr': False,
            'enable_tables': True,
    ...
    def _validate_parser_config(self, value) -> bool:
        ...
        required_keys = [
            'enable_ocr', 'enable_tables', 'generate_page_images',
            'ocr_engine', 'ocr_language', 'table_mode', 'image_scale'
        ]
