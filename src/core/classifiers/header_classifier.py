...
def _score_structural_patterns(text: str) -> float:
    ...
    # Structural keywords
    structural_keywords = [
        'section', 'part', 'chapter', 'article', 'appendix', 'introduction',
        'conclusion', 'summary', 'overview', 'background', 'methodology',
        'results', 'discussion', 'references', 'bibliography', 'information',
        'contact', 'employment', 'work', 'experience', 'education', 'skills',
...
def _is_person_name(text: str) -> bool:
    ...
    all_title_case = all(word[0].isupper() and word[1:].islower() 
...
def _is_common_form_value(text: str) -> bool:
    ...
    # Common form values
    common_values = {
        'yes', 'no', 'n/a', 'na', 'none', 'unknown', 'other',
        'male', 'female', 'single', 'married', 'divorced', 'widowed',
        'employed', 'unemployed', 'retired', 'student',
        'home', 'work', 'cell', 'mobile', 'office',
        'united states', 'usa', 'us', 'canada',
        'active', 'inactive', 'pending', 'approved', 'denied',
        'full-time', 'part-time', 'temporary', 'contract',
        'bachelor', 'master', 'doctorate', 'phd', 'high school',
        'elementary', 'middle school', 'college', 'university',
        'springfield', 'apt', 'software engineer', 'abc corporation',
        'building a', 'unit 2b', 'form w-2', 'model xyz-123', 'version',
        'page 1 of 5', 'copyright', '© 2024', 'confidential', 'draft'
    }
